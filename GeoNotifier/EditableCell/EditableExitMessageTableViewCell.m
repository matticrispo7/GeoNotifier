//
//  EditableExitMessageTableViewCell.m
//  GeoNotifier
//
...
@implementation EditableExitMessageTableViewCell
...
- (void)setEditableReminder:(Reminder *)editableReminder{
    ...
    _textField.text = _editableReminder.exitMessage;
...
- (void) textFieldDidChange {
    ...
    _editableReminder.exitMessage = _textField.text;
}
